...
class Rozo_et_al_2012_Parameters():
  def __init__(self):
    ...
    self.LxEzPow = read_data_float(tag_name = 'Lx_Ez_power',file_name = 'parameters/Models/Lxm/Rozo_et_al_2012_parameters.xml')
...
class Lxm_user_Parameters():
  def __init__(self):
    ...
    self.LxEzPow = read_data_float(tag_name = 'Lx_Ez_power',file_name = 'parameters/Models/Lxm/Lxm_user_parameters.xml')
